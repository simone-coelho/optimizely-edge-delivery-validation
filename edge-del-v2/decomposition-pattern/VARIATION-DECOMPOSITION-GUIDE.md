...
- `../reinforcement-layer/CUSTOMER-GUIDE.md` — the Edge Delivery + hydration reinforcement
  architecture this guide assumes is in place.
- `../reinforcement-layer/FINDINGS.md` — empirical hydration map (which change types Vue / React
  recover vs tolerate natively).
- `../reinforcement-layer/research-clientside-api.md` — Optimizely client-side JavaScript API
...
code becomes unnecessary, including:
  ...
  - MutationObservers that re-apply changes on re-render — handled by
    the reinforcement layer described in `../reinforcement-layer/CUSTOMER-GUIDE.md`.
...
(documented in `../reinforcement-layer/CUSTOMER-GUIDE.md`) addresses this: a worker
...
#### Change 3 (Bucket A, was originally C) — Rearrange `[data-tn-section="header"]`
  ...
  (per `../reinforcement-layer/research-clientside-api.md` §5.5, rearrange on dynamic
...
### 7.5 Author Change 4 — Custom Code (behaviour shell)
  ...
  layer (`../reinforcement-layer/CUSTOMER-GUIDE.md`) is wired into the Edge Delivery worker,
...
### 9.2 After (Edge Delivery, decomposed)
  ...
  - Hydration impact: with the reinforcement layer in place (see
    `../reinforcement-layer/CUSTOMER-GUIDE.md`), the companion re-applies any operations Vue
    ...
    `../reinforcement-layer/FINDINGS.md` §3); the additive content is the case where the
...
Per `../reinforcement-layer/research-clientside-api.md` §5.5, Optimizely's official
...
reinforcement layer described in `../reinforcement-layer/CUSTOMER-GUIDE.md`, decomposed
...
`../reinforcement-layer/FINDINGS.md`).

### 10.5 Performance Edge custom JavaScript that cannot be reverted

Per `../reinforcement-layer/research-clientside-api.md` §5.5, Optimizely Performance Edge
...
(Lifted from `../reinforcement-layer/CUSTOMER-GUIDE.md` §7.4 and `../reinforcement-layer/research-clientside-api.md`
...
### 12.4 Files in this kit relevant to the team
  ...
  - `../reinforcement-layer/CUSTOMER-GUIDE.md` — the Edge Delivery + reinforcement architecture.
  - `../reinforcement-layer/FINDINGS.md` — empirical hydration map.
  - `../reinforcement-layer/research-clientside-api.md` — Optimizely JavaScript API reference.
  - `VARIATION-DECOMPOSITION-GUIDE.md` — this document.
  - `../reinforcement-layer/customer-email.md` — customer-facing summary email for handoffs.
